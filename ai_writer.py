...
Коротко:
{{3-4 предложения простым русским языком: что произошло, кто сообщил или принял решение, что известно на данный момент и почему это важно для читателей}}
...
- пиши естественным русским языком, а не машинным дословным переводом;
- сохраняй имена, должности, даты, числа и географию без искажений;
- если факт является заявлением стороны, прямо укажи «заявил», «сообщили» или «по данным»;
